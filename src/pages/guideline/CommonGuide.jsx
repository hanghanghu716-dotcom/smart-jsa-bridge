        ...
        <div style={styles.wrapper}>
            ...
            <section style={styles.section}>
                ...
                <div style={styles.card}>
                    ...
                    {/* 이미지 경로 수정: _001, _002 형식을 반영하여 2장을 모두 출력하도록 수정합니다. */}
                    <div style={styles.imageWrapper}>
                        <p style={styles.previewLabel}>JSA 리포트 미리보기 (Internal Preview)</p>
                        {[1, 2].map((num) => (
                            <img
                                key={num}
                                // 실제 파일명인 COMMON-01_001.jpg, COMMON-01_002.jpg에 맞게 경로를 설정합니다.
                                src={`/assets/pdf/COMMON-01/COMMON-01_00${num}.jpg`}
                                alt={`COMMON-01 JSA Worksheet Preview ${num}`}
                                style={styles.previewImage}
                                // 로드 실패 시 해당 이미지만 숨김 처리합니다.
